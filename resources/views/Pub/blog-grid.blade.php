...
<div class="wrapper">
                  ...
                  <li class="has-submenu position-static"><a href="#/"><span>Shop</span></a>
                    <ul class="submenu-nav submenu-nav-mega column-3">
                      ...
                      <li class="mega-menu-item"><a href="#/" class="mega-title"><span>Single Product</span></a>
                        <ul>
                          <li><a href="single-normal-product.blade.php"><span>Single Product Normal</span></a></li>
                          <li><a href="single-product.blade.php"><span>Single Product Variable</span></a></li>
                          <li><a href="single-group-product.blade.php"><span>Single Product Group</span></a></li>
                          <li><a href="single-affiliate-product.blade.php"><span>Single Product Affiliate</span></a></li>
                        </ul>
                      </li>
            ...
            <div class="header-align-end">
              <div class="header-action-area">
                ...
                <div class="shopping-account">
                  <a class="shopping-account-btn" href="account-login.blade.php">
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="post-item">
              ...
              <div class="content">
                ...
                <h4 class="title"><a href="blog-details.blade.php">Celebrity daughter <br>opens about upto.</a></h4>
                <a class="btn-theme btn-sm" href="blog-details.blade.php">Read More</a>
              </div>
            </div>
            <!--== End Blog Item ==-->
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="post-item">
              ...
              <div class="content">
                ...
                <h4 class="title"><a href="blog-details.blade.php">Love stories of hollywood Celebrities.</a></h4>
                <a class="btn-theme btn-sm" href="blog-details.blade.php">Read More</a>
              </div>
            </div>
            <!--== End Blog Item ==-->
          ...
          <div class="col-12">
            <div class="pagination-items pagination-items-style1">
              <ul class="pagination justify-content-center mb--0">
                <li><a class="active" href="products.blade.php">1</a></li>
                <li><a href="shop-four-columns.blade.php">2</a></li>
                <li><a href="shop-three-columns.blade.php">3</a></li>
                <li><a href="products.blade.php" class="icon"><i class="fa fa-angle-right"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <div class="collapse-body">
                  <div class="widget-menu-wrap">
                    <ul class="nav-menu">
                      ...
                      <li><a href="products.blade.php">Brands</a></li>
                      <li><a href="account-login.blade.php">Gift Certificates</a></li>
                      <li><a href="products.blade.php">Specials</a></li>
  ...
  <aside class="aside-cart-wrapper offcanvas offcanvas-end" tabindex="-1" id="AsideOffcanvasCart" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
      ...
      <a class="d-block text-end lh-1" href="shop-checkout.blade.php"><img src="/assets/img/photos/paypal.webp" width="133" height="26" alt="Has-image"></a>
    </div>
  </aside>
  <!--== End Aside Cart ==-->
    ...
    <div class="offcanvas-body">
      <nav id="offcanvasNav" class="offcanvas-menu-nav">
        <ul>
          ...
          <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="about-us.blade.php">About</a></li>
          ...
          <li class="offcanvas-nav-parent"><a class="offcanvas-nav-item" href="contact.blade.php">Contact</a></li>
        </ul>
      </nav>
    </div>
  </aside>
